...
require_once dirname(__DIR__) . '/aliyunsdk/SignatureHelper.php';

use aliyunsdk\SignatureHelper;
...
class SmsApi {
     ...
     * @return \stdClass
     */
    public static function sendSms($appid,$appkey,$signName, $templateCode, $phoneNumbers, $templateParam = null, $outId = null, $smsUpExtendCode = null) {
