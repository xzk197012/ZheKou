...
class Route_NetsHaojkModel
{
    public function run($isweb = true)
    {
        global $_GPC;
        global $_W;
        require_once IA_ROOT . '/addons/nets_haojk/core/inc/page.php';
        if ($isweb)
        {
...
//		else
//		{
//			require_once NETS_HAOJIK_CORE . 'inc/page_mobile.php';
//			require_once NETS_HAOJIK_CORE . 'inc/page_mobile_login.php';
//		}
...
//			$GLOBALS['_S'] = $_W['shopset'] = $global_set;
        include $file;
        $class = ucfirst($class) . '_NetsHaojkPage';
        $instance = new $class();
