...
//查询当前会员 原openid变更为uid zxq.2018.05.17 crunchies.inc.php in 32
...
if($_W['user_info']['type']==1 && !empty($_W['user_info']['nickname'] )){
	//$_W['page']['title']=$_W['user_info']['nickname'].'的小店';
}
if($_W['user_info']['type']==1 && !empty($_W['user_info']['shopname'] )){
...
include $this->template('crunchies');
