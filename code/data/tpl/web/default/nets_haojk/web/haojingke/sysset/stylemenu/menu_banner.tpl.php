    ...
    <body>
        <div class="x-body">
            ...
            <xblock>
                ...
                <input type="hidden" name="banner_name" value="轮播图设置"/>
                <input type="hidden" name="op" value="banner"/>
            ...
            <table class="layui-table">
                ...
                <tbody id="tbody">
                <?php  if(is_array($arr)) { foreach($arr as $i => $data) { ?>
                <tr class="cube-item">
                    <td >
                    ...
                    <td>
                        <div class="input-group img-item">
                            ...
                            <input type="text" class="form-control" name="cube_img[]" value="<?php  echo $data['img'];?>" />
                    ...
                    <td>
                        <div class="input-group form-group" style="margin: 0;">
                            ...
                            <input type="text" value="<?php  echo $data['outer_url'];?>" class="form-control valid" name="banner_outer_url[]" placeholder="请输入">
                        </div>
                    </td>
                    <td>
                        <div class="input-group form-group" style="margin: 0;">
                            <select type="text"   name="cube_url[]" class="form-control valid"  placeholder="" style="width: 300px;">
...
<script language='javascript'>
    ...
    function addCube(){
        ...
        html+='<select type="text"  name="cube_url[]" class="form-control valid" style="width:300px;"  id="cubelink_'+timestamp+'">';
