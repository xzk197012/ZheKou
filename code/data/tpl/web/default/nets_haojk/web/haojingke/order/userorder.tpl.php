        ...
        <form action="" method="get"  enctype="multipart/form-data" class="layui-form layui-form-pane layui-col-md12">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" value="<?php  echo $_GPC['keyword'];?>"  name="keyword"  placeholder="订单号、会员ID" autocomplete="off" class="layui-input">
                    </div>
    ...
    <table class="layui-table">
        ...
        <tr style='background-color:#f5f1f1;'>
            <td class="text-center">
                ...
                <?php  if($r['iscountsubsidy']=="false" && ($r['validCode']==16 || $r['validCode']==17 || $r['validCode']==18) && !empty($r['finishTime']) ) { ?>
                ...
                memberid="<?php  echo $r['members']['memberid'];?>" membercommission="<?php  echo $r['my_commission1'];?>" commission="<?php  echo $r['commission'];?>"
                memberid1="<?php  echo $r['members2']['memberid'];?>" membercommission1="<?php  echo $r['my_commission2'];?>" positionId="<?php  echo $r['positionId'];?>" 
                memberid2="<?php  echo $r['members3']['memberid'];?>" membercommission2="<?php  echo $r['my_commission3'];?>" orderId="<?php  echo $r['orderId'];?>">
                    <i class="iconfont"></i>
                    <cite>提前结算</cite>
                </button>
                 <?php  } else if($r['iscountsubsidy']=="true") { ?>
