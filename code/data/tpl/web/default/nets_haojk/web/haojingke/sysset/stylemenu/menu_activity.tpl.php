...
<div class="x-body">
    ...
    <form action="" method="post"  enctype="multipart/form-data"  >
        <xblock>
            ...
            <input type="hidden" name="action_menu" value="活动菜单"/>
            <input type="hidden" name="op" value="menu_activity"/>
        ...
        <table class="layui-table">
            ...
            <tbody id="tbody">
            <?php  if(is_array($re_picture_menu2)) { foreach($re_picture_menu2 as $i => $data) { ?>
            <tr class="cube-item">
                <td >
                ...
                <td>
                    <div class="input-group img-item">
                        ...
                        <input type="text" class="form-control" name="action_menu_img[]" value="<?php  echo $data['img'];?>" />
                ...
                <td>
                    <div class="input-group form-group" style="margin: 0;">
                        <input type="text" value="<?php  echo $data['name'];?>" class="form-control valid" style="width: 150px;" name="action_menu_name[]" placeholder=""> 
                    </div>
                </td>
                <td>
                    <div class="input-group form-group" style="margin: 0;">

                        <input type="text" value="<?php  echo $data['outer_url'];?>" class="form-control valid" name="action_outer_url[]" placeholder="请输入">
                    </div>
                </td>
                <td>
                    <div class="input-group form-group" style="margin: 0;">
                        <select type="text"   name="action_menu_url[]" class="form-control valid"  placeholder="" style="width: 300px;">
...
<script language='javascript'>
    ...
    function addCube(){
        ...
        var html='<tr class="cube-item">';
            ...
            html+='</div>';
            html+='<input type="text" class="form-control" name="action_menu_img[]" />';
            ...
            html+='<input type="text" value="" class="form-control valid" name="action_menu_name[]" placeholder="" style="width:150px;" id="cubelink_'+timestamp+'">';
            html+='</div>';
            html+='</td><td><div class="input-group form-group" style="margin: 0;"><input type="text" value="" class="form-control valid" style="width: 180px;" name="action_outer_url[]" placeholder="请输入"></div>';
            html+='</td><td><div class="input-group form-group" style="margin: 0;">';
            html+='<select type="text"  name="action_menu_url[]" class="form-control valid" style="width:200px;"  id="cubelink_'+timestamp+'">';
