...
<div class="x-body">
    ...
    <form action="" method="post"  enctype="multipart/form-data"  >
        ...
        <table class="layui-table">
            ...
            <tbody id="tbody">
            <?php  if(is_array($re_head_menu)) { foreach($re_head_menu as $i => $data) { ?>
            <tr class="cube-item">
                <td >
                ...
                <td>
                    <div class="input-group img-item">
                        ...
                        <input type="text" class="form-control" name="head_menu_img[]" value="<?php  echo $data['img'];?>" />
                ...
                <td>
                    <div class="input-group form-group" style="margin: 0;">
                        <input type="text" value="<?php  echo $data['name'];?>" class="form-control valid" name="head_menu_name[]" style="width:150px;" placeholder="">
                       
                    </div>
                </td>
                <td>
                    <div class="input-group form-group" style="margin: 0;">
                        <input type="text" value="<?php  echo $data['outer_url'];?>" class="form-control valid" name="head_outer_url[]" placeholder="请输入">
                    </div>
                </td>
                <td>
                    <div class="input-group form-group" style="margin: 0;">
