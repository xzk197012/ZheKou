...
<div class="x-body">
    ...
    <form action="" method="post"  enctype="multipart/form-data"  >
        <xblock>
            ...
            <input type="hidden" name="picture_menu_name_show" value="图片菜单"/>
            <input type="hidden" name="op" value="menu_pic"/>
        ...
        <table class="layui-table">
            ...
            <tbody id="tbody">
            <?php  if(is_array($re_picture_menu)) { foreach($re_picture_menu as $i => $data) { ?>
            <tr class="cube-item">
                <td >
                ...
                <td>
                    <div class="input-group img-item">
                        ...
                        <input type="text" class="form-control" name="picture_menu_img[]" value="<?php  echo $data['img'];?>" />
                ...
                <td>
                    <div class="input-group form-group" style="margin: 0;">
                        ...
                        <input type="text" value="<?php  echo $data['outer_url'];?>" class="form-control valid" name="picture_outer_url[]" placeholder="请输入">
                    </div>
                </td>
                <td>
                    <div class="input-group form-group" style="margin: 0;">
                        <select type="text"   name="picture_menu_url[]" class="form-control valid"  placeholder="" style="width: 300px;">
...
<script language='javascript'>
    ...
    function addCube(){
        ...
        html+='</div>';
        html+='<input type="text" class="form-control" name="picture_menu_img[]" />';
        ...
        html+='<select type="text"  name="picture_menu_url[]" class="form-control valid" style="width:300px;"  id="cubelink_'+timestamp+'">';
